...
getElement("#id").onblur=()=>{
  ...
  if(!VALIDATION.checkID("#id","HS")){
    getElement("#tbId").innerHTML="Mã học sinh phải có HS đứng đầu"
  }else if(!VALIDATION.checkLength("#id",4,8)){
    getElement("#tbId").innerHTML="Mã học sinh phải có độ dài từ 4 đến 8"
  }else if(!VALIDATION.checkLetterNumber("#id")){
    getElement("#tbId").innerHTML="Mã học sinh phải bao gồm chữ và số"
    console.log(!VALIDATION.checkLetterNumber("#id"))
  }else if(VALIDATION.checkEmty("#id")){
    getElement("#tbId").innerHTML="Mã học sinh không được bỏ trống"
  }else{
...
getElement("#name").onblur=()=>{
  ...
  if(VALIDATION.checkEmty("#name")){
    getElement("#tbName").innerHTML="Tên học sinh không được bỏ trống"
  }
  else if(!VALIDATION.checkLetter("#name")){
    getElement("#tbName").innerHTML="Tên học sinh phải là chữ"
  }
  else{
...
getElement("#adress").onblur=()=>{
  ...
  }else if(!VALIDATION.checkLetter("#adress")){
    getElement("#tbAdress").innerHTML="Địa chỉ phải có chữ"
  }else{
